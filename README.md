...
>
> <b>2026년 6월 23일</b> — 누구나 바로 쓸 수 있는 **ParserTry 배포판**을 공개했습니다.
> **윈도우·맥·리눅스** 어디서나 별도 준비 없이, 압축을 풀고 **더블클릭** 한 번이면 설치부터 실행까지
> 자동으로 진행됩니다(첫 실행 시 자동 설치). **21종 파서**를 한 화면에서 비교해 보세요.
>
> ➡️ **[가장 쉬운 설치 안내 보기](#-가장-쉬운-설치-누구나--터미널-불필요)**
